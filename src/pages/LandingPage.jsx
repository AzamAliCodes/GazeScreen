      ...
      >
        ...
        >
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 10, flexWrap: 'wrap' }}>
            <span className="brutal-tag tag-blue">HealthTech Track</span>
            <span className="brutal-tag tag-pink">iQOO 2026</span>
            <span className="brutal-tag tag-yellow">MarkovX</span>
            <div
              style={{
                display: 'flex',
                alignItems: 'center',
          ...
          <div style={{ maxWidth: 840, width: '100%', textAlign: 'center' }}>
            ...
            >
              <div style={{ display: 'inline-flex', marginBottom: 14 }}>
                ...
                >
                  <DecryptedText text="MARKOVX · DIGITAL BIOMARKER ENGINE" speed={25} />
                </span>
              </div>
        ...
        >
          <div style={{ maxWidth: 940, margin: '0 auto', display: 'flex', alignItems: 'flex-start', gap: 16, flexWrap: 'wrap' }}>
            ...
            <p style={{ fontSize: '0.85rem', color: 'var(--ink)', lineHeight: 1.7, margin: 0, flex: 1 }}>
              ...
              assessment by a licensed developmental pediatrician or child psychologist. Developed by <strong style={{ color: 'var(--blue-600)' }}>MarkovX</strong> for
              the iQOO Hackathon 2026 — HealthTech Track.
            </p>
          </div>
        </footer>
      </div>
